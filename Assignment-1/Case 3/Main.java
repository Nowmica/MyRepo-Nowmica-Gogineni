...
public class Main 
{
    ...
    * It also explains the usage of local variable.
    * @return null
    */
...
class EmpDetails extends Main
	...
	/**
	*This method is used to display the employee Work details.
	*It also shows the access of public and protected variables name,age from the super class
	@return null
	*/
	public void display()
	{
